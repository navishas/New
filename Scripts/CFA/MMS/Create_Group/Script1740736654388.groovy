...
String SubLocalityValue = findTestData('Data Files/Operational_Dashboard/Group_Merchant/Group_onboarding').getValue('Sub_Locality', 
    1)
...
String CycleValue = findTestData('Data Files/Operational_Dashboard/Group_Merchant/Group_onboarding').getValue('Settlement_Cycle', 
